...
class Model{
	...
	protected function addField(array $options){
		...
		$name=$options['name'];
		$field=array('set'=>self::FIELD_SET_ANYWHERE,'value'=>null,'type'=>TRUE,'getCallback'=>null,'setCallback'=>null);
	...
	public function __set($name,$val){
		...
		if($this->fields[$name]['set']==self::FIELD_SET_ONLYONCE&&$this->fields[$name]['value']!==null){
			throw new \Exception('Cannot set '.get_class($this).'.'.$name.', premission denied');
			return null;
		}
